...
@Controller
public class aHandbagsController {
	...
	@RequestMapping(value = { "/admin/product/handbags" })
	public ModelAndView loadProduct(HttpServletRequest request, HttpServletResponse response) {
		...
		mv.addObject("handbags", "true");
		return mv;
	}

	@RequestMapping(value = { "/admin/product/handbags/add" })
	...
	@RequestMapping(value = "/admin/product/add-new-handbags/savefile", method = RequestMethod.POST)
	public ModelAndView upload(@RequestParam(value = "filetag", required = false) MultipartFile file,
		...
		if (image != null) {
			if (title != null && price != null && discount != null && style != null && gender != null && user != null
				...
				return new ModelAndView("redirect: /ShopTandT/admin/product/handbags/add");
			}
		} else {
	...
	@RequestMapping(value = "/admin/product/handbags-gallery/savefile", method = RequestMethod.POST)
	public ModelAndView shoes(@RequestParam(value = "filetag", required = false) MultipartFile[] file,
		...
		if (check) {
			session.setAttribute("addhandbags", "true");
			return new ModelAndView("redirect: /ShopTandT/admin/product/handbags/add-gallery");
		} else {
			return new ModelAndView("redirect: /ShopTandT/admin/product/handbags/add-gallery");
		}
