...
<title>Add accessories gallery</title>
...
<body>
			...
			<div class="nav-history">
				...
				<div>
					...
					<img
						...
						alt=""> <a href="">Add Accessories Gallery</a>
				</div>
			</div>

			<div class="table-add-new-product">
				<form action="/ShopTandT/admin/product/accessories-gallery/savefile"
	...
	<c:if test="${ sessionScope.addaccessories != null }">
		<script type="text/javascript">
			var check = "${ sessionScope.addaccessories }";
			if (check == "true") {
				...
				$("#gallery-add .ok-notify")
						.click(
								function() {
									...
									xhr
											.open("GET",
													"/ShopTandT/admin/product/accessories/add-gallery?continue");
									xhr.onload = function() {
										window.location
												.assign("/ShopTandT/admin/product/accessories/add-gallery");
									};
									xhr.send();
								});
				$("#gallery-add .cancel")
						.click(
								function() {
									...
									xhr
											.open("GET",
													"/ShopTandT/admin/product/accessories?accessoriesgallery&cancel");
									xhr.onload = function() {
										window.location
												.assign("/ShopTandT/admin/product/accessories");
									};
									xhr.send();
								});
			}
