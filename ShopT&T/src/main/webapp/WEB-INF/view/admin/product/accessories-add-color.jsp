...
<title>Add Accessories Color</title>
			...
			<div class="nav-history">
				...
				<div>
					...
					<img
						...
						alt=""> <a href="">Add Accessories Color</a>
				</div>
			</div>
					...
					<table class="table-new-product">
						...
						<tr>
							<td>
								...
								<!-- <div class="gotogallery"><a href="">Go to Gallery add</a></div> -->
							</td>
						</tr>
					</table>
				</form>
   	...
   	$("#addcolor").click(function() {
   		...
   		if(name == "") {
			...
			$('.ok-done').click(function() {
   			...
   			$('#myform').attr('action', '/ShopTandT/admin/color-size/add-color?accessories');
