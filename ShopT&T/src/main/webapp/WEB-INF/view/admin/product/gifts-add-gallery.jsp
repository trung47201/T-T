...
<body>
			...
			<div class="nav-history">
				...
				<div>
					...
					<img
						...
						alt=""> <a href="/ShopTandT/admin/product/gifts">Gifts</a>
				</div>
				<div>
					<p>/</p>
					<img
						src="<c:url value="/assets/images/icons/icons8-add-64-title.png"/>"
						alt=""> <a href="">Add Gifts Gallery</a>
				</div>
			</div>

			<div class="table-add-new-product">
				<form action="/ShopTandT/admin/product/gifts-gallery/savefile"
	...
	<c:if test="${ sessionScope.addgifts != null }">
		<script type="text/javascript">
			var check = "${ sessionScope.addgifts }";
			if (check == "true") {
				...
				$("#gallery-add .ok-notify")
						.click(
								function() {
									...
									xhr
											.open("GET",
													"/ShopTandT/admin/product/gifts/add-gallery?continue");
									xhr.onload = function() {
										window.location
												.assign("/ShopTandT/admin/product/gifts/add-gallery");
									};
									xhr.send();
								});
				$("#gallery-add .cancel")
