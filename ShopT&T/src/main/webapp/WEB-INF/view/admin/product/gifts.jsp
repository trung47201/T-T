			...
			<div class="nav-history">
				...
				<div>
					...
					<img src="<c:url value="/assets/images/icons/icons8-bag-100.png"/>"
						alt=""> <a href="/ShopTandT/admin/product/handbags">Gifts</a>
				</div>
			</div>
					...
					<thead>
						<tr>
							<th colspan="1000" class="td-addnewshoes">
								<div class="btn-add">
									<a href="/ShopTandT/admin/product/gifts/add">
									...
									</a> <a href="/ShopTandT/admin/product/add-gifts-color">
										<button class="addnewshoes addnewproduct"
											id="addnewshoes-product">
											<img
												src="<c:url value="/assets/images/icons/icons8-add-64.png"/>"
												alt="icon-plus">Gifts Color
										</button>
									</a> <a href="/ShopTandT/admin/product/gifts/add-gallery">
										<button class="addnewshoes addnewproduct"
											id="addnewshoes-product">
											<img
												src="<c:url value="/assets/images/icons/icons8-add-64.png"/>"
												alt="icon-plus">Gifts Gallery
										</button>
									</a>
								</div>
							</th>
