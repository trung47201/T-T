			...
			<div class="nav-history">
				...
				<div>
					...
					<img src="<c:url value="/assets/images/icons/icons8-bag-100.png"/>"
						alt=""> <a href="/ShopTandT/admin/product/handbags">Accessories</a>
				</div>
			</div>
					...
					<thead>
						<tr>
							<th colspan="1000" class="td-addnewshoes">
								<div class="btn-add">
									<a href="/ShopTandT/admin/product/accessories/add">
										<button class="addnewshoes addnewproduct"
											id="addnewshoes-product">
											<img
												src="<c:url value="/assets/images/icons/icons8-add-64.png"/>"
												alt="icon-plus">Accessories
										</button>
									</a> <a href="/ShopTandT/admin/product/add-accessories-color">
										<button class="addnewshoes addnewproduct"
											id="addnewshoes-product">
											<img
												src="<c:url value="/assets/images/icons/icons8-add-64.png"/>"
												alt="icon-plus">Accessories Color
										</button>
									</a> <a href="/ShopTandT/admin/product/accessories/add-gallery">
										<button class="addnewshoes addnewproduct"
											id="addnewshoes-product">
											<img
												src="<c:url value="/assets/images/icons/icons8-add-64.png"/>"
												alt="icon-plus">Accessories Gallery
										</button>
									</a>
								</div>
							</th>
