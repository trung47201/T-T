		...
		<div class="nav-history">
			<div class="origin">
				<img
					...
					alt=""> <a href="/ShopTandT/shipper">Home</a>
			</div>
			<div>
				<p>/</p>
				<img
			...
			<div>
				...
				<img
					src="<c:url value="/assets/images/icons/icons8-calendar-96.png"/>"
					alt=""> <a href="/ShopTandT/shipper/order-management">Management</a>
			</div>
	...
	<script type="text/javascript">
		...
		if(take_order == "true") {
			...
			$('.ok').click(function() {
				...
				xhr.open("GET", "/ShopTandT/shipper/order-management?ok");
				xhr.onload = function() {
					window.location.assign("/ShopTandT/shipper/order-management");
				};
				xhr.send();
			});
		}
	...
	<script>
		$('.btn-confirm-order').click(function() {
			...
			$('.ok').click(function() {
				$(".message-notify").addClass("none");
				var xhr = new XMLHttpRequest();
				xhr.open("GET", "/ShopTandT/shipper/order-management?id_order="+ id_order);
				xhr.onload = function() {
					window.location.assign("/ShopTandT/shipper/order-management");
				};
				xhr.send();
