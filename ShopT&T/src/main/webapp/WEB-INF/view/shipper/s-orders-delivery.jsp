...
<body>
			...
			<div class="nav-history">
				...
				<div>
					<img
						...
						alt=""> <a href="/ShopTandT/shipper/delivery">Profile</a>
				</div>
				<p>/</p>
				<div>
					<img
	...
	<c:if test="${ listOrder == null && search != null }">
		...
		$('.btn-details-order')
				.click(
						function() {
							...
							window.location
									.assign("/ShopTandT/shipper/order-management/order-details?id_order="
											+ id_order);
						});
	</script>
							...
							$('.ok')
									.click(
											function() {
												...
												xhr.onload = function() {
													window.location
															.assign("/ShopTandT/shipper/delivery");
												};
												xhr.send();
											});
						});
