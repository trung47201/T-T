	...
	<script type="text/javascript">
	    ...
	    scanner.addListener('scan',function(content){
	    	if(Number.isInteger(parseInt(content))) {
	    		 window.location.href="/ShopTandT/shipper/cancel-delivery/" +content;
	    	} else {
	    		 window.location.href="/ShopTandT/shipper/cancel-delivery/0";
	    	}
	    });
...
<c:if test="${ canceled == 'false' }">
	<script type="text/javascript">
		var delay = 1000; 
		setTimeout(function(){ window.location = "/ShopTandT/shipper/cancel-delivery"; }, delay);
	</script>
</c:if>
<script
