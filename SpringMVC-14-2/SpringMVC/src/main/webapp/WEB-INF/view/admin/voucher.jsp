...
<body>
		...
		<form action="/SpringMVC/admin/voucher" method="post">
			<div class="add-new-order-form">
				...
				<div class="btn-add-new-vc">
					<button class="addneworder" id="addnewvoucher" name="addnewvoucher"
						type="button">
						<img src="<c:url value="/assets/images/icons/icons8-add-64.png"/>"
	...
	<c:if test="${ editvoucher == 'true' }">
		<form action="/SpringMVC/admin/voucher/edit-voucher/${ vch.id }" method="post">
			<div class="add-new-order-form">
				<div class="customer-infor">
					<div class="customer-infor-form">
						<div class="fullname">
							<p>ID</p>
							<input type="text" id="id" name="id" readonly value="${ vch.id }">
						</div>
						<div class="fullname">
							<p>Code</p>
					...
					<div class="customer-infor-form">
						...
						<div class="fullname">
							...
							<input type="number" min="0" id="limit-input" name="limit-input"
								placeholder="Enter the limit you want..." value="${ vch.limit }">
						</div>
					</div>
					<div class="customer-infor-form">
						<div class="fullname">
